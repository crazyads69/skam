import { Controller, Get, HttpException, Req, ServiceUnavailableException } from '@nestjs/common'
...
export class HealthController {
  ...
  public async getHealth(
    ...
    const allowed: boolean = await this.cache.fixedWindowLimit(`ratelimit:health:${identifier}`, 60, 60)
